...
export default function Dissertacoes() {
  ...
  React.useEffect(() => {
    if (articles.length > 0) {
      setFilteredArticles(articles.filter(article => article.category === "Dissertações"));
    }
  }, [articles]);
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {loading ? (
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground">Carregando dissertações...</p>
          </div>
        ) : error ? (
          <div className="text-center py-16">
            <h3 className="text-2xl font-semibold text-destructive mb-4">
              Erro ao carregar dissertações
            </h3>
